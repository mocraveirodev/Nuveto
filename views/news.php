...
<body>
    <header>
        <nav data-scroll-header class="navbar navbar-expand-xl navbar-dark fixed-top">
            <div class="container">
                <a data-scroll class="navbar-brand" href="/?home"><img src="views/img/LogoNuvetoBrancaVer.png" class="header-logo" alt="Logo Nuveto"></a>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            <h3>Pronto!</h3>
                            <p>Já realizamos sua inscrição na Newsletter da Nuveto.</p>
            ...
            <div class="modal fade" id="modalErro" tabindex="-1" role="dialog" aria-labelledby="modalErroTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            <h3>Erro!</h3>
                            <p>Houve na realização da sua inscrição. Tente de novo mais tarde!</p>
                            <a class="btn btn-success btn-padrao" data-dismiss="modal" aria-label="Fechar">OK</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="footer-text">
                    ...
                    <div class="footer-map">
                        <div class="footer-map-empresa">
                            <nav>
                                <ul>
                                    <li><a data-scroll href="/?home" class="footer-map-titulo">Empresa</a></li>
